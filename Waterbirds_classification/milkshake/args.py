...
def add_input_args(parser):
    ...
    parser.add("--interactive_mode", default=True, type=lambda x: bool(strtobool(x)),
               help="Whether to use the model is running on a compute cluster.")
    ...
    parser.add("--save_dir", default=None,
               help="The name of the directory for logging.") 
    ...
    parser.add("--resnet_version", choices=[8, 18, 34, 50, 101, 152], default=50, type=int,
    ...
    parser.add("--vit_version", choices=["base", "large"], default="large",
