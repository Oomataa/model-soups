...
def valid_model_and_datamodule_names():
    ...
    datamodule_names = [n for n in milkshake.datamodules.__all__ if n not in ("dataset", "Idxloader", "datamodule")]
...
def valid_debiase_mechanisms():
    ...
    other_debiased_methods = ["ARL"]
    return finetune_types + other_debiased_methods
